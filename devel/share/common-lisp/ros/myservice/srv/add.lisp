...
(cl:defmethod cl:initialize-instance :after ((m <add-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myservice-srv:<add-request> is deprecated: use myservice-srv:add-request instead.")))

(cl:ensure-generic-function 'num1-val :lambda-list '(m))
(cl:defmethod num1-val ((m <add-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myservice-srv:num1-val is deprecated.  Use myservice-srv:num1 instead.")
  (num1 m))

(cl:ensure-generic-function 'num2-val :lambda-list '(m))
(cl:defmethod num2-val ((m <add-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myservice-srv:num2-val is deprecated.  Use myservice-srv:num2 instead.")
  (num2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <add-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'add-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name myservice-srv:<add-response> is deprecated: use myservice-srv:add-response instead.")))

(cl:ensure-generic-function 'sum-val :lambda-list '(m))
(cl:defmethod sum-val ((m <add-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader myservice-srv:sum-val is deprecated.  Use myservice-srv:sum instead.")
  (sum m))
